                                        ...
                                        <?php 
                                            if ($get_all_user->num_rows > 0) {
                                                while($row = mysqli_fetch_assoc($get_all_user)) {
                                                    ...
                                                    $get_user_info_query = "SELECT smallarea.NAME AS small_area_name, bigarea.NAME AS big_area_name, record.NAME AS record_name, bigarea.ID AS bigareaid
                                                    FROM user
                                                    ...
                                                    if ($row['ROLEID'] != 2 && $user_info['bigareaid'] == $user['BIGAREAID']){
                                                        echo "
                                                            <tr>        
                                                                <td>".$row['ID']."</td>

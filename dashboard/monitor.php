...
<body class="vertical  light collapsed  ">
    ...
    function loadXMLDoc1() {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("allListMonitor").innerHTML = this.responseText;
            }
        };
        xhttp.open("GET", "allListMonitor.php", true);
        xhttp.send();
    }
    ...
    function loadXMLDoc2() {
        ...
        xhttp.open("GET", "singleCandidateMonitor.php", true);
        xhttp.send();
    }
    ...
    window.onload = function() {
        loadXMLDoc1();
        loadXMLDoc2();
        setInterval(loadXMLDoc1, 1000);
        setInterval(loadXMLDoc2, 1000);
    };
    </script>

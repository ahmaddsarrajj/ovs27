            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        ...
                        <?php
                                if($user['ROLEID'] == 2) {
                                include "../components/startTime.php"; 
                        }?>
                        ...
                        <div class="row items-align-baseline">
                            ...
                            <?php
                                if($user['ROLEID'] == 2) {
                                include "../components/dashboard/analycis/getNumberOfCandidate.php"; ?>

                            <?php include "../components/dashboard/analycis/getNumberOfVoters.php" ?>
                            <?php include "../components/dashboard/analycis/getNumberOfVotesPerVoter.php" ?>
